...
from jarvissian.version import (
    version,
    package_version,
    cwltool_version,
    calrissian_version,
...
class VersionTestCase(TestCase):
    ...
    def test_assembles_vession_string(
        self, mock_calrissian_version, mock_cwltool_version
    ):
    ...
    def test_package_version_unknown(self, mock_pkg_resources):
        ...
        mock_pkg_resources.require.side_effect = (
            mock_pkg_resources.DistributionNotFound()
        )
    ...
    def test_package_version_known(self, mock_pkg_resources):
        mock_pkg_resources.require.return_value = [
            Mock(version="1.2.3"),
        ]
