...
from jarvissian.report import TimedReport, TimedResourceReport, TimelineReport
from jarvissian.report import (
    Event,
    MaxParallelCountProcessor,
    MaxParallelCPUsProcessor,
    MaxParallelRAMProcessor,
)
from jarvissian.report import MemoryParser, CPUParser, Reporter
from jarvissian.report import (
    initialize_reporter,
    write_report,
    default_serializer,
...
class TimedResourceReportTestCase(TestCase):
    def setUp(self):
        self.report = TimedResourceReport(
            name="timed-resource-report", start_time=TIME_1000, finish_time=TIME_1015
        )
...
class TimelineReportTestCase(TestCase):
    ...
    def test_total_cpu_hours(self):
        ...
        self.report.add_report(
            TimedResourceReport(start_time=TIME_1000, finish_time=TIME_1100, cpus=1)
        )
        self.report.add_report(
            TimedResourceReport(start_time=TIME_1000, finish_time=TIME_1015, cpus=4)
        )
    ...
    def test_total_ram_megabyte_hours(self):
        ...
        self.report.add_report(
            TimedResourceReport(
                start_time=TIME_1000, finish_time=TIME_1100, ram_megabytes=1024
            )
        )
        self.report.add_report(
            TimedResourceReport(
                start_time=TIME_1000, finish_time=TIME_1015, ram_megabytes=8192
            )
        )
    ...
    def test_max_parallel_tasks_handles_start_finish_bounds(self):
        ...
        task_1000_1015 = TimedResourceReport(
            start_time=TIME_1000, finish_time=TIME_1015
        )
        task_1015_1030 = TimedResourceReport(
            start_time=TIME_1015, finish_time=TIME_1030
        )
    ...
    def test_max_parallel_cpus_discrete(self):
        ...
        self.report.add_report(
            TimedResourceReport(start_time=TIME_1000, finish_time=TIME_1015, cpus=1)
        )
        self.report.add_report(
            TimedResourceReport(start_time=TIME_1015, finish_time=TIME_1030, cpus=1)
        )
        self.report.add_report(
            TimedResourceReport(start_time=TIME_1030, finish_time=TIME_1045, cpus=1)
        )
        self.report.add_report(
            TimedResourceReport(start_time=TIME_1045, finish_time=TIME_1100, cpus=1)
        )
    ...
    def test_max_parallel_cpus_overlap(self):
        ...
        self.report.add_report(
            TimedResourceReport(start_time=TIME_1000, finish_time=TIME_1030, cpus=1)
        )
        self.report.add_report(
            TimedResourceReport(start_time=TIME_1015, finish_time=TIME_1045, cpus=1)
        )
        self.report.add_report(
            TimedResourceReport(start_time=TIME_1030, finish_time=TIME_1100, cpus=1)
        )
        self.assertEqual(self.report.total_tasks(), 3)
    ...
    def test_max_parallel_cpus_complex(self):
        ...
        self.report.add_report(
            TimedResourceReport(start_time=TIME_1000, finish_time=TIME_1045, cpus=1)
        )
        self.report.add_report(
            TimedResourceReport(start_time=TIME_1030, finish_time=TIME_1100, cpus=1)
        )
    ...
    def test_max_parallel_ram_megabytes_discrete(self):
        ...
        self.report.add_report(
            TimedResourceReport(
                start_time=TIME_1000, finish_time=TIME_1015, ram_megabytes=1024
            )
        )
        self.report.add_report(
            TimedResourceReport(
                start_time=TIME_1015, finish_time=TIME_1030, ram_megabytes=1024
            )
        )
        self.report.add_report(
            TimedResourceReport(
                start_time=TIME_1030, finish_time=TIME_1045, ram_megabytes=1024
            )
        )
        self.report.add_report(
            TimedResourceReport(
                start_time=TIME_1045, finish_time=TIME_1100, ram_megabytes=1024
            )
        )
        self.assertEqual(self.report.total_tasks(), 4)
    ...
    def test_max_parallel_ram_megabytes_overlap(self):
        ...
        self.report.add_report(
            TimedResourceReport(
                start_time=TIME_1000, finish_time=TIME_1030, ram_megabytes=1024
            )
        )
        self.report.add_report(
            TimedResourceReport(
                start_time=TIME_1015, finish_time=TIME_1045, ram_megabytes=1024
            )
        )
        self.report.add_report(
            TimedResourceReport(
                start_time=TIME_1030, finish_time=TIME_1100, ram_megabytes=1024
            )
        )
        self.assertEqual(self.report.total_tasks(), 3)
...
class EventTestCase(TestCase):
    ...
    def test_processor(self):
        ...
        self.assertTrue(
            mock_processor.process.call_args, call(mock_report, Event.START)
        )
...
class MemoryParserTestCase(TestCase):
    ...
    def test_parse_to_megabytes(self):
        ...
        self.assertEqual(MemoryParser.parse_to_megabytes("1K"), 0.001)
...
class ReporterFunctionsTestCase(TestCase):
    ...
    def test_write_report(self, mock_json, mock_open):
        ...
        Reporter.add_report(
            TimedResourceReport(
                cpus=1, ram_megabytes=128, start_time=TIME_1000, finish_time=TIME_1100
            )
        )
