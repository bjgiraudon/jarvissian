...
def retry_exponential_if_exception_type(exc_type, logger):
    ...
    return retry(
        ...
        wait=wait_exponential(
            multiplier=RetryParameters.MULTIPLIER,
            min=RetryParameters.MIN,
            max=RetryParameters.MAX,
        ),
